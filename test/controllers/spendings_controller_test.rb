...
class SpendingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spending" do
    assert_difference('Spending.count') do
      post spendings_url, params: { spending: { month: @spending.month, payment: @spending.payment } }
    end
  ...
  test "should update spending" do
    patch spending_url(@spending), params: { spending: { month: @spending.month, payment: @spending.payment } }
